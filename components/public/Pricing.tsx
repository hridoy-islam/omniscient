...
export default function Pricing() {
    return <div className="py-14">
        <div className="text-center px-10 space-y-4 py-10">
            <h3>PRICING PLANS</h3>
            <h2 className="text-primary text-4xl font-semibold">Transparent Pricing, Tailored Solutions</h2>
            <p className="px-20">Tailored solutions, unbeatable value – because your journey to excellence starts with a clear path and a partner you can trust. Welcome to a new era of mining, where pricing meets perfection.</p>
        </div>
        <div className="grid grid-cols-4 gap-4 mx-8">
            <Card className="border border-primary p-6 space-y-4">
                <Chip className="bg-primaryLight rounded-md align-center p-4 mb-3">Basic Mining</Chip>
