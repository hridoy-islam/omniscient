...
export default function Mining() {
  return (
    <div className="text-center container mx-auto space-y-4 py-10">
      ...
      <p className="px-20">
        ...
        Elevate your mining experience with unparalleled scale and efficiency.
        Welcome to the future of mining – welcome to Mining Giants.
      </p>
      <Image
        src={mining}
        alt="mining"
